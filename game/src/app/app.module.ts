...
import { LiveSportsComponent } from './home/live-sport/live-sport.component';
import { PopularMatchesComponent } from './sports/main/highlights/popular-matches/popular-matches.component';
import { SportsSidebarComponent } from './sports/sports-sidebar/sports-sidebar.component';
import { MainComponent } from './sports/main/main.component';
import { HighlightLiveSportsComponent } from './sports/main/highlights/highlight-live-sport/highlight-live-sport.component';
import { HighlightsComponent } from './sports/main/highlights/highlights.component';
...
@NgModule({
  declarations: [
    ...
    WalletComponent,
    SportsSidebarComponent,
    PopularMatchesComponent,
    MainComponent,
    HighlightsComponent,
    HighlightLiveSportsComponent,
  ],
  imports: [
    BrowserModule,
